...
Route::middleware('auth:company')->group(function () {
    ...
    Route::get('company/employees/{employee}', [CompanyController::class, 'showEmployee'])->name('company.employee.show');
    Route::get('company/employees/{employee}/edit', [CompanyController::class, 'editEmployee'])->name('company.employee.edit');
    Route::put('company/employees/{employee}', [CompanyController::class, 'updateEmployee'])->name('company.employee.update');
